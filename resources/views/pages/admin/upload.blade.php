                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2">
                                                            <a class="btn btn-success btn-md mb-3" type="button"
                                                                data-bs-toggle="modal" data-bs-target="#editproduk{{ $product->id }}"
                                                                style="color: #FFFFFF; font-size: 13px; border-radius: 5px;">{{ __('Edit') }}</a>
...
<section id="ProductEdit">
    <div class="modal fade" id="editproduk{{ $product->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
        tabindex="-1" aria-labelledby="editproduk{{ $product->id }}" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">

            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel"
                        style="color: #5F5B00; font-size: 20px; font-weight: 400;">Edit Data</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div style="padding: 1rem">

                    <div class="card-body">
                        <form action="{{ route('adminp.update', $product) }}" method="POST"
