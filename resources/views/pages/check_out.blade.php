                                ...
                                <tbody>
                                    ...
                                    @foreach ($order_details as $order_detail)
                                        <tr>
                                            <td>{{ $no++ }}</td>
                                            <td>
                                                <img src="{{ url('uploads') }}/{{ $order_detail->product->gambar }}"
                                                    width="100" alt="...">
                                            </td>
                                            ...
                                            <td>
                                                <form action="{{ url('check-out') }}/{{ $order_detail->id }}"
                                                    method="post">
                                                    @csrf
                                                    {{ method_field('DELETE') }}
                                    ...
                                    <tr>
                                        ...
                                        <td align="right"><strong>Rp. {{ number_format($order->jumlah_harga) }}</strong>
                                        </td>
                                        <td>
