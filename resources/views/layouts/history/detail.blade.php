                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $no++ }}</td>
                                <td>
                                    <img src="{{ url('uploads') }}/{{ $order_detail->produk->gambar }}" width="100" alt="...">
                                </td>
                                <td>{{ $order_detail->produk->produk_name }}</td>
                                <td>{{ $order_detail->jumlah }} kain</td>
                                <td align="right">Rp. {{ number_format($order_detail->produk->harga) }}</td>
